...
const seedProducts = [
  {
    ...
    price: 149,
    compareAtPrice: 199,
    images: JSON.stringify(["https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=600&h=600&fit=crop", "https://images.unsplash.com/photo-1603561596112-0a132b757442?w=600&h=600&fit=crop"]),
    category: "BAGUE",
    material: "OR_PLAQUE",
    stock: 15,
  ...
  },
  {
    ...
    price: 199,
    compareAtPrice: 249,
    images: JSON.stringify(["https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=600&h=600&fit=crop", "https://images.unsplash.com/photo-1602751584552-8ba73aad10e1?w=600&h=600&fit=crop"]),
    category: "BAGUE",
    material: "ARGENT_925",
    stock: 8,
  ...
  },
  {
    ...
    price: 179,
    compareAtPrice: null,
    images: JSON.stringify(["https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=600&h=600&fit=crop"]),
    category: "BAGUE",
    material: "OR_ROSE",
    stock: 12,
    sizes: JSON.stringify(["16mm", "17mm", "18mm", "19mm"]),
  ...
  },
  {
    ...
    price: 249,
    compareAtPrice: 299,
    images: JSON.stringify(["https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=600&h=600&fit=crop", "https://images.unsplash.com/photo-1515562141589-67f0d569b34e?w=600&h=600&fit=crop"]),
    category: "COLLIER",
    material: "OR_PLAQUE",
    stock: 6,
  ...
  },
  {
    ...
    price: 129,
    compareAtPrice: null,
    images: JSON.stringify(["https://images.unsplash.com/photo-1611652022419-a9419f74343d?w=600&h=600&fit=crop"]),
    category: "COLLIER",
    material: "ARGENT_925",
    stock: 20,
  ...
  },
  {
    ...
    price: 199,
    compareAtPrice: 259,
    images: JSON.stringify(["https://images.unsplash.com/photo-1573408301185-9146fe634ad0?w=600&h=600&fit=crop", "https://images.unsplash.com/photo-1602173574767-37ac01994b2a?w=600&h=600&fit=crop"]),
    category: "COLLIER",
    material: "CRISTAL",
    stock: 4,
  ...
  },
  {
    ...
    price: 169,
    compareAtPrice: 219,
    images: JSON.stringify(["https://images.unsplash.com/photo-1573408301185-9146fe634ad0?w=600&h=600&fit=crop"]),
    category: "BRACELET",
    material: "OR_PLAQUE",
    stock: 10,
  ...
  },
  {
    ...
    price: 139,
    compareAtPrice: null,
    images: JSON.stringify(["https://images.unsplash.com/photo-1535632787350-4e68ef0ac584?w=600&h=600&fit=crop"]),
    category: "BRACELET",
    material: "ARGENT_925",
    stock: 18,
    sizes: JSON.stringify(["S", "M", "L"]),
  ...
  },
  {
    ...
    price: 189,
    compareAtPrice: 239,
    images: JSON.stringify(["https://images.unsplash.com/photo-1602751584552-8ba73aad10e1?w=600&h=600&fit=crop"]),
    category: "BRACELET",
    material: "OR_ROSE",
    stock: 7,
    sizes: JSON.stringify(["S", "M", "L"]),
  ...
  },
  {
    ...
    price: 159,
    compareAtPrice: 199,
    images: JSON.stringify(["https://images.unsplash.com/photo-1630019852942-f89202989a59?w=600&h=600&fit=crop", "https://images.unsplash.com/photo-1617038260897-41a1f14a8ca0?w=600&h=600&fit=crop"]),
  ...
  },
  {
    ...
    price: 119,
    compareAtPrice: 149,
    images: JSON.stringify(["https://images.unsplash.com/photo-1617038260897-41a1f14a8ca0?w=600&h=600&fit=crop"]),
    category: "BOUCLES_OREILLES",
